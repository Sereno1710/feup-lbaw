...
VALUES
  ('gago', 'daniel@email.com', 'daniel', 3500.00, '2003-11-15', 'Rua do Daniel', 'Faro', '12345', 'Portugal'),
  ('sereno', 'jose@email.com', 'jose', 2000.00, '2003-03-23', 'Rua do Jose', 'Guimaraes', '123123', 'Portugal'),
...
VALUES
  ...
  ('Handcrafted Flute', 'A beautifully handcrafted flute with exquisite details.', 150.00, '2023-10-05 14:00:00', '2023-11-20 14:00:00', 'woodwinds', 'active', 3, NULL),
  ('Vintage Bass Guitar', 'An old-school bass guitar with a unique vibe.', 250.00, '2023-10-03 12:00:00', '2023-11-18 12:00:00', 'brass', 'active', 3, NULL),
  ('Handmade Drum Set', 'A custom-made drum set for professional drummers.', 400.00, '2023-10-10 15:00:00', '2023-11-25 15:00:00', 'percussion', 'active', 3, NULL),
  ('Grand Piano', 'A beautifully maintained grand piano with a rich, deep tone.', 800.00, '2023-10-07 11:00:00', '2023-11-22 11:00:00', 'strings', 'active', 3, NULL),
  ('Vintage Trumpet', 'A classic trumpet with a warm and mellow sound.', 120.00, '2023-10-02 09:00:00', '2023-11-17 09:00:00', 'brass', 'active', 3, NULL),
  ('Electric Guitar Kit', 'A DIY electric guitar kit for guitar enthusiasts.', 80.00, '2023-10-04 13:00:00', '2023-11-19 13:00:00', 'strings', 'active', 3, NULL),
  ('Cajon Drum', 'A versatile and portable cajon drum for musicians on the go.', 60.00, '2023-10-08 16:00:00', '2023-11-23 16:00:00', 'percussion', 'active', 3, NULL),
  ('Saxophone Quartet', 'A set of four saxophones for ensemble performances.', 350.00, '2023-10-06 10:00:00', '2023-11-21 10:00:00', 'woodwinds', 'active', 3, NULL);
