...
VALUES
  ...
  ('Violin and Bow Set', 'A high-quality violin with a matching bow.', 18.00, '2023-10-11 10:00:00', '2023-10-25 10:00:00', 'strings', 'finished', 3),
  ('Classic Flute', 'A classic flute for professional musicians.', 300.00, '2023-10-12 11:00:00', '2023-10-26 11:00:00', 'woodwinds', 'finished', 3),
  ('Vintage Drum Machine', 'A vintage drum machine for electronic music production.', 250.00, '2023-10-13 12:00:00', '2023-10-27 12:00:00', 'percussion', 'finished', 3),
  ('Saxophone Solo', 'A high-end saxophone for solo performances.', 400.00, '2023-10-14 13:00:00', '2023-10-28 13:00:00', 'woodwinds', 'finished', 19),
  ('Trumpet Masterclass', 'A masterclass session with a renowned trumpet player.', 150.00, '2023-10-15 14:00:00', '2023-10-29 14:00:00', 'brass', 'finished', 21),
  ('Bass Guitar Workshop', 'A workshop on advanced bass guitar techniques.', 180.00, '2023-10-16 15:00:00', '2023-10-30 15:00:00', 'brass', 'finished', 23),
  ('Piano Concerto Tickets', 'Tickets for a grand piano concerto event.', 120.00, '2023-10-17 16:00:00', '2023-10-31 16:00:00', 'strings', 'finished', 25),
  ('Electronic Music Production Course', 'A comprehensive course on electronic music production.', 220.00, '2023-10-18 17:00:00', '2023-11-01 17:00:00', 'percussion', 'finished', 27),
  ('Accordion Performance', 'A live performance featuring accordion music.', 180.00, '2023-10-19 18:00:00', '2023-11-02 18:00:00', 'woodwinds', 'finished', 29),
  ('Drumming Masterclass', 'A masterclass session on advanced drumming techniques.', 250.00, '2023-10-20 19:00:00', '2023-11-03 19:00:00', 'percussion', 'finished', 31),
  ('Guitar Effects Pedal', 'A high-quality effects pedal for electric guitars.', 80.00, '2023-10-21 10:00:00', '2023-11-04 10:00:00', 'strings', 'paused', 33),
  ('Digital Piano', 'A digital piano with realistic piano sound.', 300.00, '2023-10-22 11:00:00', '2023-11-05 11:00:00', 'strings', 'paused', 34),
  ('Trombone Ensemble', 'A set of trombones for ensemble performances.', 180.00, '2023-10-23 12:00:00', '2023-11-06 12:00:00', 'brass', 'paused', 35),
  ('Synthesizer Keyboard', 'A synthesizer keyboard for electronic music artists.', 250.00, '2023-10-24 13:00:00', '2023-11-07 13:00:00', 'percussion', 'paused', 36),
  ('Harmonica Set', 'A set of harmonicas for blues and folk music.', 100.00, '2023-10-25 14:00:00', '2023-11-08 14:00:00', 'woodwinds', 'paused', 37),
  ('Drumming Workshop', 'A workshop on drumming techniques for beginners.', 150.00, '2023-10-26 15:00:00', '2023-11-09 15:00:00', 'percussion', 'paused', 38),
  ('Guitar and Vocal Lessons', 'Lessons for both guitar and vocal training.', 200.00, '2023-10-27 16:00:00', '2023-11-10 16:00:00', 'strings', 'paused', 39),
  ('Flute Duet', 'A duet of high-quality flutes for musicians.', 180.00, '2023-10-28 17:00:00', '2023-11-11 17:00:00', 'woodwinds', 'paused', 40),
  ('Percussion Ensemble', 'An ensemble performance featuring various percussion instruments.', 300.00, '2023-10-29 18:00:00', '2023-11-12 18:00:00', 'percussion', 'paused', 41),
  ('Saxophone Solo Performance', 'A live solo performance with a saxophone.', 150.00, '2023-10-30 19:00:00', '2023-11-13 19:00:00', 'woodwinds', 'paused', 42),
  ('Electric Violin', 'An electric violin with modern sound capabilities.', 400.00, '2023-11-01 10:00:00', '2023-11-15 10:00:00', 'strings', 'approved', 43),
  ('Clarinet Duet', 'A duet of high-quality clarinets for musicians.', 300.00, '2023-11-02 11:00:00', '2023-11-16 11:00:00', 'woodwinds', 'approved', 44),
  ('Trumpet Quartet', 'A quartet of trumpets for ensemble performances.', 250.00, '2023-11-03 12:00:00', '2023-11-17 12:00:00', 'brass', 'approved', 45),
  ('Guitar Masterclass', 'A masterclass session with a renowned guitarist.', 350.00, '2023-11-04 13:00:00', '2023-11-18 13:00:00', 'strings', 'approved', 46),
  ('Piano Duet', 'A duet of grand pianos for classical music lovers.', 500.00, '2023-11-05 14:00:00', '2023-11-19 14:00:00', 'strings', 'approved', 47),
  ('Drumming Workshop', 'A workshop on advanced drumming techniques.', 250.00, '2023-11-06 15:00:00', '2023-11-20 15:00:00', 'percussion', 'approved', 48),
  ('Accordion Ensemble', 'An ensemble performance featuring accordions.', 200.00, '2023-11-07 16:00:00', '2023-11-21 16:00:00', 'woodwinds', 'approved', 49),
  ('Saxophone Solo Performance', 'A live solo performance with a saxophone.', 300.00, '2023-11-08 17:00:00', '2023-11-22 17:00:00', 'woodwinds', 'approved', 50),
  ('Vocal Masterclass', 'A masterclass session with a renowned vocalist.', 200.00, '2023-11-09 18:00:00', '2023-11-23 18:00:00', 'percussion', 'approved', 51),
  ('Bass Guitar Solo', 'A live solo performance featuring a bass guitar.', 150.00, '2023-11-10 19:00:00', '2023-11-24 19:00:00', 'brass', 'approved', 52),
  ('Xylophone Set', 'A set of xylophones for school and ensemble use.', 200.00, '2023-11-11 10:00:00', '2023-11-25 10:00:00', 'percussion', 'denied', 53),
  ('Keyboard Ensemble', 'An ensemble performance featuring electronic keyboards.', 180.00, '2023-11-12 11:00:00', '2023-11-26 11:00:00', 'percussion', 'disabled', 54),
  ('Harmonica Masterclass', 'A masterclass session for harmonica enthusiasts.', 250.00, '2023-11-13 12:00:00', '2023-11-27 12:00:00', 'woodwinds', 'denied', 55),
  ('Drumming Solo', 'A live solo drumming performance by a professional.', 200.00, '2023-11-14 13:00:00', '2023-11-28 13:00:00', 'percussion', 'denied', 26),
  ('Guitar Ensemble', 'An ensemble performance featuring various guitars.', 300.00, '2023-11-15 14:00:00', '2023-11-29 14:00:00', 'strings', 'denied', 20),
  ('Brass Quartet', 'A quartet of brass instruments for ensemble performances.', 180.00, '2023-11-16 15:00:00', '2023-11-30 15:00:00', 'brass', 'disabled', 5),
  ('Piano Solo Performance', 'A live solo piano performance by a professional pianist.', 250.00, '2023-11-17 16:00:00', '2023-12-01 16:00:00', 'strings', 'denied', 7),
  ('Flute Solo', 'A live solo flute performance by a professional flutist.', 200.00, '2023-11-18 17:00:00', '2023-12-02 17:00:00', 'woodwinds', 'denied', 9),
  ('Trumpet Masterclass', 'A masterclass session with a renowned trumpet player.', 300.00, '2023-11-19 18:00:00', '2023-12-03 18:00:00', 'brass', 'denied', 6),
  ('Accordion Workshop', 'A workshop on accordion playing for beginners.', 150.00, '2023-11-20 19:00:00', '2023-12-04 19:00:00', 'woodwinds', 'denied', 23);
