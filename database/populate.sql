...
VALUES
 ('gago','Daniel Gago' ,'daniel@email.com', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 3500.00, '2003-11-15', NULL, 'Rua do Twistzz', 'Faro', '12345', 'Portugal', NULL),
 ('sereno','José Santos', 'jose@email.com', 'josepass', 2000.00, '2003-03-23', NULL, 'Avenida dos Desdentados', 'Guimaraes', '123123', 'Portugal', NULL),
 ...
 ('max',' Máximo Pereira','maximo@email.com', 'maxpass', 1000.00, '2003-01-13', NULL, 'Rua do Inspetor', 'Gondomar', '4420-123', 'Portugal', NULL),
 ('zemanel','José Manuel' ,'zemanel@hotmail.com', 'password123', 5.00, '1992-02-10', NULL, 'Rua Santa Catarina', 'Porto', '34567', 'Portugal', NULL),
 ('darkknight','Bruce Wayne' ,'brucewayne@email.com', 'batman123', 1000000.00, '1980-05-10', NULL, 'Gotham Street', 'Gotham City', '12345', 'USA', NULL),
 ('webslinger','Peter Parker' ,'peterparker@email.com', 'spidey', 50000.00, '1995-02-14', NULL, 'Web Avenue', 'New York', '54321', 'USA', NULL),
 ('greenqueen','Pamela Isley', 'pamelaisley@email.com', 'poisonivy', 75000.00, '1987-09-20', NULL, 'Vine Lane', 'Gotham City', '67890', 'USA', NULL),
 ('speedster','Barry Allen' ,'barryallen@email.com', 'flash2023', 90000.00, '1986-03-30', NULL, 'Speedster Street', 'Central City', '98765', 'USA', NULL),
 ('emeraldarcher','Oliver Queen', 'oliverqueen@email.com', 'arrow', 80000.00, '1981-11-11', NULL, 'Arrow Road', 'Star City', '23456', 'USA', NULL),
 ('manofsteel','Clark Kent' ,'clarkkent@email.com', 'kryptonite', 95000.00, '1978-07-01', NULL, 'Super Lane', 'Metropolis', '76543', 'USA', NULL),
 ('wonderwoman','Diana Prince' ,'dianaprince@email.com', 'amazonian', 85000.00, '1985-04-15', NULL, 'Paradise Island', 'Themyscira', '78901', 'Amazon', NULL),
 ('thor','Thor Odinson' ,'thor@email.com', 'mjolnir', 70000.00, '1980-12-25', NULL, 'Asgard Road', 'Asgard', '11223', 'Asgard', NULL),
 ('spymaster', 'Natasha Romanoff','natasharomanoff@email.com', 'blackwidow', 60000.00, '1984-08-03', NULL, 'Red Room Street', 'Moscow', '00123', 'Russia', NULL),
 ('starkgenius', 'Tony Stark','tonystark@email.com', 'ironman', 1200000.00, '1970-06-21', NULL, 'Stark Tower', 'New York', '54321', 'USA', NULL),
 ('godofthunder', 'Loki Odinson','loki@email.com', 'trickster', 90000.00, '1972-03-05', NULL, 'Asgard Palace', 'Asgard', '11223', 'Asgard', NULL),
 ('hawkeye', 'Clint Barton','clintbarton@email.com', 'hawkeye1', 75000.00, '1976-09-08', NULL, 'Archery Way', 'Brooklyn', '45678', 'USA', NULL),
 ('scarletwitch', 'Wanda Maximoff' ,'wandamaximoff@email.com', 'chaosmagic', 70000.00, '1989-12-16', NULL, 'Hex Street', 'Transia', '98765', 'Transia', NULL),
 ('aquaman', 'Arthur Curry' ,'arthurcurry@email.com', 'kingofthesea', 85000.00, '1982-07-30', NULL, 'Atlantis Avenue', 'Atlantis', '54321', 'Atlantis', NULL),
 ('beastmode','Hank Mccoy' ,'hankmccoy@email.com', 'bluefur', 60000.00, '1988-02-04', NULL, 'X-Mansion Road', 'Westchester', '33333', 'USA', NULL),
 ('stormrider','Ororo Munroe' ,'ororomunroe@email.com', 'weathergoddess', 95000.00, '1987-06-10', NULL, 'Wakanda Avenue', 'Wakanda', '11223', 'Wakanda', NULL),
 ('greenlantern','Hal Jordan' ,'haljordan@email.com', 'ringpower', 80000.00, '1983-04-20', NULL, 'Oa Street', 'Oa', '22222', 'Oa', NULL),
 ('wolverine','James Howlett','logan@email.com', 'adamantium', 70000.00, '1842-03-22', NULL, 'Logan Street', 'Alberta', '77777', 'Canada', NULL),
 ('wallywest','Wally West' ,'wallywest@email.com', 'kidflash', 90000.00, '1992-08-15', NULL, 'Speedster Lane', 'Keystone City', '11111', 'USA', NULL),
 ('wadeywilson','Wade Wilson' ,'wadewilson@email.com', 'deadpool', 80000.00, '1974-02-20', NULL, 'Regeneration Road', 'New York', '54321', 'USA', NULL),
 ('blackpanther','Tchalla' ,'tchalla@email.com', 'vibranium', 85000.00, '1980-11-29', NULL, 'Wakanda Street', 'Wakanda', '11223', 'Wakanda', NULL),
 ('magentawitch','Wanda Sheperd' ,'wandashepherd@email.com', 'wandavision', 75000.00, '1993-05-07', NULL, 'Salem Road', 'Westview', '54321', 'USA', NULL),
 ('ladyhawk','Katelyn' ,'katebishop@email.com', 'hawkeye2', 70000.00, '1999-12-03', NULL, 'Archer Avenue', 'New York', '45678', 'USA', NULL),
 ('captainspandex','Steve' ,'steve@email.com', 'capamerica', 95000.00, '1920-07-04', NULL, 'Freedom Street', 'Washington, D.C.', '12345', 'USA', NULL),
 ('aquaticmariner','Namor' ,'namor@email.com', 'imperiusrex', 90000.00, '1940-01-10', NULL, 'Atlantean Lane', 'Atlantis', '22222', 'Atlantis', NULL),
 ('starlord','Peter Quill' ,'peterquill@email.com', 'guardians1', 80000.00, '1982-12-18', NULL, 'Milano Avenue', 'Xandar', '98765', 'Xandar', NULL),
 ('blackbolt','Black Agar' ,'blackagar@email.com', 'silentscream', 75000.00, '1975-06-02', NULL, 'Inhuman Road', 'Attilan', '54321', 'Attilan', NULL),
 ('colossus','Piotr rasputin' ,'piotrrasputin@email.com', 'steelman', 90000.00, '1978-03-14', NULL, 'X-Mansion Lane', 'Westchester', '33333', 'USA', NULL),
 ('gamora', 'Gamora','gamora@email.com', 'deadlyassassin', 85000.00, '1984-09-03', NULL, 'Zen-Whoberi Street', 'Zen-Whoberi', '11223', 'Zen-Whoberi', NULL),
 ('antman','Scott Lang' ,'scottlang@email.com', 'shrinkandgrow', 70000.00, '1980-01-22', NULL, 'Pym Particles Lane', 'New York', '45678', 'USA', NULL),
 ('zatanna','Zatanna Zatara' ,'zatannazatara@email.com', 'magicwords', 80000.00, '1986-10-31', NULL, 'Mystic Road', 'Shadowcrest', '54321', 'USA', NULL),
 ('stormqueen','Aurora Munroe' ,'auroramunroe@email.com', 'elementalpowers', 90000.00, '1985-07-19', NULL, 'Wakanda Lane', 'Wakanda', '98765', 'Wakanda', NULL),
 ('redskull','Johann Schmidt' ,'johannschmidt@email.com', 'hydra123', 75000.00, '1941-11-02', NULL, 'Nazi Avenue', 'Berlin', '00123', 'Germany', NULL),
 ('mysterio','Quentin Beck' ,'quentinbeck@email.com', 'illusions', 70000.00, '1969-04-15', NULL, 'Fishbowl Street', 'New York', '54321', 'USA', NULL),
 ('cyclops','Scott Summer' ,'scottsummers@email.com', 'opticblast', 85000.00, '1973-08-26', NULL, 'X-Mansion Avenue', 'Westchester', '33333', 'USA', NULL),
 ('rogue','Anna Marie' ,'annamarie@email.com', 'drainpowers', 90000.00, '1987-06-04', NULL, 'Mississippi Road', 'Caldecott', '54321', 'USA', NULL),
 ('iceprincess','Bobby Drake' ,'bobbydrake@email.com', 'iceman', 70000.00, '1982-03-30', NULL, 'Frost Lane', 'North Salem', '11223', 'USA', NULL),
 ('blacksuit','Eddie Mayne' ,'eddieredmayne@email.com', 'venomized', 80000.00, '1988-12-14', NULL, 'Symbiote Street', 'New York', '45678', 'USA', NULL),
 ('scarecrow', 'John Crane','jonathancrane@email.com', 'feargas', 75000.00, '1970-10-20', NULL, 'Fear Lane', 'Gotham City', '00123', 'USA', NULL),
 ('invisiblewoman','Susan Storm' ,'susanstorm@email.com', 'invisibility', 90000.00, '1983-07-22', NULL, 'Fantastic Road', 'New York', '54321', 'USA', NULL),
 ('nightcrawler','Kurt Wagner' ,'kurtwagner@email.com', 'teleportation', 85000.00, '1984-05-05', NULL, 'Bamf Avenue', 'Bavaria', '22222', 'Germany', NULL),
 ('lizardking','Connor','drconnors@email.com', 'reptilian', 80000.00, '1977-09-11', NULL, 'Reptile Lane', 'New York', '98765', 'USA', NULL),
 ('rocketraccoon','Rocket' ,'rocket@email.com', 'blaster', 75000.00, '1990-12-05', NULL, 'Guardian Avenue', 'Halfworld', '54321', 'Halfworld', NULL),
 ('sandman', 'Flint','flintmarko@email.com', 'sandpowers', 90000.00, '1965-03-18', NULL, 'Desert Lane', 'New York', '11223', 'USA', NULL),
 ('starfire', 'Korian' ,'koriandrs@email.com', 'starbolts', 85000.00, '1988-07-29', NULL, 'Tamaran Road', 'Tamaran', '12345', 'Tamaran', NULL),
 ('juggernaut','Cain' ,'cainmarko@email.com', 'unstoppable', 80000.00, '1971-02-03', NULL, 'Juggernaut Street', 'Cain Marko', '33333', 'Marko', NULL),
 ('raven', 'Rachel','rachelroth@email.com', 'darkmagic', 70000.00, '1980-10-26', NULL, 'Azarath Lane', 'Azarath', '54321', 'Azarath', NULL),
 ('magneto', 'Erik Lensherr' ,'eriklensherr@email.com', 'magnetism', 90000.00, '1963-06-05', NULL, 'Mutant Lane', 'Genosha', '22222', 'Genosha', NULL),
 ('hulk', 'Bruce Banner','brucebanner@email.com', 'smash', 85000.00, '1962-05-02', NULL, 'Gamma Road', 'New York', '98765', 'USA', NULL);
