...
VALUES
('Rare Acoustic Guitar', 'A vintage acoustic guitar with a unique sound.', 80.00, '2023-09-01 10:00:00', '2024-10-24 01:30:00', 'strings', 'active', 3, NULL),
('Handcrafted Flute', 'A beautifully handcrafted flute with exquisite details.', 70.00, '2023-09-05 14:00:00', '2024-11-20 14:00:00', 'woodwinds', 'active', 4, NULL),
('Vintage Bass Guitar', 'An old-school bass guitar with a unique vibe.', 30.00, '2023-09-03 12:00:00', '2024-11-18 12:00:00', 'brass', 'active', 5, NULL),
('Handmade Drum Set', 'A custom-made drum set for professional drummers.', 25.00, '2023-09-10 15:00:00', '2024-11-25 15:00:00', 'percussion', 'active', 6, NULL),
('Grand Piano', 'A beautifully maintained grand piano with a rich, deep tone.', 60.00, '2023-09-07 11:00:00', '2024-11-22 11:00:00', 'strings', 'active', 7, NULL),
('Vintage Trumpet', 'A classic trumpet with a warm and mellow sound.', 27.00, '2023-09-02 09:00:00', '2024-11-17 09:00:00', 'brass', 'active', 8, NULL),
('Electric Guitar Kit', 'A DIY electric guitar kit for guitar enthusiasts.', 45.00, '2023-09-04 13:00:00', '2024-11-19 13:00:00', 'strings', 'active', 9, NULL),
('Cajon Drum', 'A versatile and portable cajon drum for musicians on the go.', 60.00, '2023-09-08 16:00:00', '2024-11-23 16:00:00', 'percussion', 'active', 10, NULL),
('Saxophone Quartet', 'A set of four saxophones for ensemble performances.', 35.00, '2023-09-06 10:00:00', '2024-11-21 10:00:00', 'woodwinds', 'active', 11, NULL),
('Electronic Keyboard', 'A modern electronic keyboard with various sound options.', 20.00, '2023-09-09 14:00:00', '2024-11-24 14:00:00', 'percussion', 'active', 12, NULL),
('Violin and Bow Set', 'A high-quality violin with a matching bow.', 18.00, '2023-10-11 10:00:00', '2023-10-25 10:00:00', 'strings', 'finished', 13, 14),
...
INSERT INTO Notification (notification_type, date, viewed, receiver_id)
VALUES
  ('auction_paused', NOW() - INTERVAL '1 day', false, 2),
  ('auction_finished', NOW() - INTERVAL '2 days', false, 3),
  ('auction_approved', NOW() - INTERVAL '3 days', false, 4),
  ('auction_denied', NOW() - INTERVAL '4 days', false, 5),
  ('auction_comment', NOW() - INTERVAL '5 days', false, 6),
  ('auction_bid', NOW() - INTERVAL '6 days', false, 7),
  ('user_upgrade', NOW() - INTERVAL '7 days', false, 8),
  ('user_downgrade', NOW() - INTERVAL '8 days', false, 9),
  ('auction_paused', NOW() - INTERVAL '9 days', false, 10),
  ('auction_finished', NOW() - INTERVAL '10 days', false, 11),
  ('auction_approved', NOW() - INTERVAL '11 days', false, 12),
  ('auction_denied', NOW() - INTERVAL '12 days', false, 13),
  ('auction_comment', NOW() - INTERVAL '13 days', false, 14),
  ('auction_bid', NOW() - INTERVAL '14 days', false, 15),
  ('user_upgrade', NOW() - INTERVAL '15 days', false, 16),
  ('user_downgrade', NOW() - INTERVAL '16 days', false, 17),
  ('auction_paused', NOW() - INTERVAL '17 days', false, 18),
  ('auction_finished', NOW() - INTERVAL '18 days', false, 19),
  ('auction_approved', NOW() - INTERVAL '19 days', false, 20),
  ('auction_denied', NOW() - INTERVAL '20 days', false, 21),
  ('auction_comment', NOW() - INTERVAL '21 days', false, 22),
  ('auction_bid', NOW() - INTERVAL '22 days', false, 23),
  ('user_upgrade', NOW() - INTERVAL '23 days', false, 24),
  ('user_downgrade', NOW() - INTERVAL '24 days', false, 25),
  ('auction_paused', NOW() - INTERVAL '25 days', false, 26),
  ('auction_finished', NOW() - INTERVAL '26 days', false, 27),
  ('auction_approved', NOW() - INTERVAL '27 days', false, 28),
  ('auction_denied', NOW() - INTERVAL '28 days', false, 29),
  ('auction_comment', NOW() - INTERVAL '29 days', false, 30),
  ('auction_bid', NOW() - INTERVAL '30 days', false, 31),
  ('user_upgrade', NOW() - INTERVAL '31 days', false, 32),
  ('user_downgrade', NOW() - INTERVAL '32 days', false, 33),
  ('auction_paused', NOW() - INTERVAL '33 days', false, 34),
  ('auction_finished', NOW() - INTERVAL '34 days', false, 35),
  ('auction_approved', NOW() - INTERVAL '35 days', false, 36),
  ('auction_denied', NOW() - INTERVAL '36 days', false, 37),
  ('auction_comment', NOW() - INTERVAL '37 days', false, 38),
  ('auction_bid', NOW() - INTERVAL '38 days', false, 39),
  ('user_upgrade', NOW() - INTERVAL '39 days', false, 40),
  ('user_downgrade', NOW() - INTERVAL '40 days', false, 41),
  ('auction_paused', NOW() - INTERVAL '41 days', false, 42),
  ('auction_finished', NOW() - INTERVAL '42 days', false, 43),
  ('auction_approved', NOW() - INTERVAL '43 days', false, 44),
  ('auction_denied', NOW() - INTERVAL '44 days', false, 45),
  ('auction_comment', NOW() - INTERVAL '45 days', false, 46),
  ('auction_bid', NOW() - INTERVAL '46 days', false, 47),
  ('user_upgrade', NOW() - INTERVAL '47 days', false, 48),
  ('user_downgrade', NOW() - INTERVAL '48 days', false, 49);
