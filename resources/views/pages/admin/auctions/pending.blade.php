...
@section('content')
<h1 class="mx-8 text-4xl font-bold">Pending Auctions</h1>
        <br>
            ...
            <div class="flex flex-col sm:flex-row md:flex-row lg:flex-col">
                <table class="table-auto text-center" id="auctions_table">
                        ...
                        <tr id="auction_row_{{$auction->id}}">
                            ...
                            <td class="p-2 border-b-2 border-slate-300">{{ $auction->state }}</td>
                            <td class="p-2 border-b-2 border-slate-300 flex flex-row">
                            <button auction_id="{{ $auction->id }}" class="m-2 py-1 px-2 text-white bg-stone-800 rounded approve-btn" type="button">Approve</button>
                            <button auction_id="{{ $auction->id }}" class="m-2 py-1 px-2 text-white bg-stone-800 rounded reject-btn" type="button">Reject</button>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
